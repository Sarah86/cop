...
const Programacao = require('../data/enpoe.json')
...
export const EnpoeMobile = ({ defaultActiveKeyAccordion, defaultActiveKeyTab }) => {
...
export const EnpoeTabelaDesktop = () => {
